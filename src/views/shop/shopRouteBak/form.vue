<template>
    <div  style="padding-top: 30px" >
        ...
        <el-form ref="form" :model="form" :rules="rules" size="small"   style="padding-left: 30px" label-width="80px">
            <el-row>
                <el-col :span="12">
            ...
            <el-row>
                <el-col :span="20">
                    <el-form-item label="介绍">
                        ...
                        <div ref="editor"  class="toolbar"  v-model="form.introduce"  >
                            <p v-model="form.introduce" />
                        </div>
                        <el-input type="hidden" ref="introduce"  v-model="form.introduce" />
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>

        <div slot="footer" class="dialog-footer" style="padding-left: 130px;padding-bottom: 30px">
...
<script>
    ...
    export default {
        ...
        methods: {
            getInfoFromId() {
                getFromId(this.$route.query['id']).then(res => {
                    this.form = res;
        ...
        mounted() {
            ...
            editor.create();
            editor.txt.html(this.$refs['introduce'].value);

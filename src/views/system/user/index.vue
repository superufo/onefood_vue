    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="17" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
          ...
          <el-table-column prop="shopId" label="店铺" :formatter="formatShopID"   />
...
import { getFromId } from '@/api/shop'
...
export default {
  ...
  data() {
    return {
      ...
      showName:"",
      formatShopID: function (row, column) {
          if ( row.shopId > 0 ){
              if (row.shopId==1){
                  return "super shop";
              } else {
                  getFromId(row.shopId).then((res) => {
                         this.showName = res.ename;
                  });

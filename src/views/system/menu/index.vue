...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.getMenus()
      _this.form = { id: data.id, component: data.component, name: data.name, sort: data.sort, pid: data.pid, path: data.path, hidden: data.hidden.toString(), iframe: data.iframe.toString(), roles: [], icon: data.icon }
      _this.dialog = true
    },
    changExpand() {
